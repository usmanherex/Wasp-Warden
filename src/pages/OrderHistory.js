...
import { Truck, Package, CheckCircle, Clock, DollarSign, Filter, Mail, Phone, MapPin, User,BadgeCheck,AlertCircle, PackageCheck } from 'lucide-react';
          ...
          {filteredOrders.map((order) => (
            ...
            >
              ...
              <CardContent className="pt-6">
                ...
                <div className="mt-6 flex items-center gap-2 text-sm bg-gray-50 p-2 rounded-lg">
